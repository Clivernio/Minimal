...
function dw_kido_scripts() {
	...
	wp_enqueue_style( 'dw_kido_css', get_template_directory_uri() . $assets['css'], false, null );
	wp_enqueue_style( 'dw_kido_style', get_stylesheet_uri(), false );

	wp_enqueue_script( 'modernizr', get_template_directory_uri() . $assets['modernizr'], array(), null, false );
	wp_enqueue_script( 'jquery' );
	wp_enqueue_script( 'jquery-masonry' );
	wp_enqueue_script( 'dw_kido_js', get_template_directory_uri() . $assets['js'], array(), null, true );

	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}

	wp_localize_script('dw_kido_js', 'dw_kido', array(
