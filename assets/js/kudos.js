...
(function() {
  ...
  Kudoable = (function() {
    function Kudoable(element) {
      ...
      this.bindEvents();
      this.counter = jQuery('.count .num', this.element);
    ...
    Kudoable.prototype.bindEvents = function() {
      ...
      jQuery(this.element).on('touchstart', this.element, this.start);
      return jQuery(this.element).on('touchend', this.element, this.end);
    };
  ...
  jQuery(function(jQuery) {
    return jQuery.fn.kudoable = function() {
      return this.each(function() {
        return new Kudoable(jQuery(this));
      });
    };
  });
